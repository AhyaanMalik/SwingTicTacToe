...
/**
 * Tic Tac Toe in Swing (Dice Mode)
 * 
 * @author Ahyaan Malik
 * @version 3/20/2026
 */
public class DiceMode extends MouseAdapter implements ActionListener {
    ...
    public DiceMode(CardLayout cardLayout, JPanel cards) {
        ...
        // Top label
        mainText = new JLabel("Tic Tac Toe (Dice Mode)", SwingConstants.CENTER);
        ...
        rand = new Random();
        rolledText = new JLabel("Haven't rolled yet", SwingConstants.CENTER);
        rolledText.setFont(rolledText.getFont().deriveFont(14.0f));
        panel.add(rolledText, BorderLayout.NORTH);
    }
